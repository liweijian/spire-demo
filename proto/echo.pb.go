...
const file_proto_echo_proto_rawDesc = "" +
	"\n" +
	"\x10proto/echo.proto\x12\x05proto\"\x1d\n" +
	"\aRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\"$\n" +
	"\bResponse\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage25\n" +
	"\x04Echo\x12-\n" +
	"\bSayHello\x12\x0e.proto.Request\x1a\x0f.proto.Response\"\x00B\x12Z\x10spire-demo/protob\x06proto3"
...
var file_proto_echo_proto_depIdxs = []int32{
	0, // 0: proto.Echo.SayHello:input_type -> proto.Request
	1, // 1: proto.Echo.SayHello:output_type -> proto.Response
